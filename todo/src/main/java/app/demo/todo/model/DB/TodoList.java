...
public class TodoList extends ArrayList<Todo> {
    ...
    public static final TodoList fromTodoListDB(final List<Todo> todos) {
    ...
    public static final TodoList fromTodoListUI(final List<app.demo.todo.model.UI.Todo> todos) {
        TodoList retVal = null;

        if (todos != null) {
            retVal = new TodoList();
            for (app.demo.todo.model.UI.Todo e : todos) {
